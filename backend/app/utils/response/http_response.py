...
class ORJSONResponse(JSONResponse):
    ...
    def render(self, content: typing.Any) -> bytes:
        return orjson.dumps(
            ...
            | None,  # 数据库未配置
            default=None,  # 数据库未配置 default_serialize
        )
...
def resp_401(*, data: str = None, msg: str = "未授权，请重新登录(401)") -> Response:
    return ORJSONResponse(
        ...
        content={"code": 401, "msg": msg, "data": data},
    )
...
def resp_422(
    *, data: str = None, msg: typing.Union[list, dict, str] = "不可处理的实体"
) -> Response:
    return ORJSONResponse(
...
def resp_500(
    *, data: str = None, msg: typing.Union[list, dict, str] = "服务器错误(500)"
) -> Response:
    return ORJSONResponse(
...
def resp_502(*, data: str = None, msg: str = "网络错误(502)") -> Response:
    return ORJSONResponse(
        ...
        content={"code": 502, "msg": msg, "data": data},
    )
...
def resp_410(
    *, data: str = None, msg: str = "请求的资源被永久删除，且不会再得到的(410)"
) -> Response:
    return ORJSONResponse(
        status_code=status.HTTP_410_GONE,
        content={"code": 410, "msg": msg, "data": data},
    )
