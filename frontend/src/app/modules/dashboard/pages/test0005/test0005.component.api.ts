...
export class Test0005Service {
  ...
  // 发送消息并取得回复(流式传输)
  sendMessageStream(entity: HttpParam, signal: AbortSignal): Promise<Response> {
  ...
  // 发送消息后的登录/更新
  updateSend(entity: SendParam): Observable<SendSingleMessage> {
    return this.http.post<SendSingleMessage>('/api/cosmos_api/test0005/update_send', entity)
  }
}
